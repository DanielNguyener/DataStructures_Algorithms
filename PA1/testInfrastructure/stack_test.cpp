...
int testStackLinkedListCopyConstructor() {
    ...
    while (!s.isEmpty()) {
        ...
        cout << "s2: head " << s2.top() << " s head: " << s.top() << endl;      
        if (s2.pop() != s.pop()) {
...
int main() {
    ...
    try {
        ...
        if (tscore == 0) {
            cout << "Test Stack Copy Constructor Failed 1" << endl;
        } else {
            cout << "Test Stack Copy Constructor Passed" << endl;
        }
        finalScore += tscore;
    } catch (const std::exception& e) {
        cout << "Test Stack Copy Constructor Failed 2" << endl;
    }
    ...
    try {
        ...
        cout << "Test Stack Copy Constructor Failed 3" << endl;
    }
    ...
    try {
        ...
        if (tscore == 0) {
            cout << "Test Stack Copy Constructor Failed 4" << endl;
        } else {
            cout << "Test Stack Copy Constructor Passed" << endl;
        }
        finalScore += tscore;
    } catch (const std::exception& e) {
        cout << "Test Stack Copy Constructor Failed 5" << endl;
    }
    ...
    try {
        ...
        cout << "Test Stack Copy Constructor Failed 6" << endl;
    }
    ...
    try {
        ...
        if (tscore == 0) {
            cout << "Test Stack Copy Constructor Failed 7" << endl;
        } else {
            cout << "Test Stack Copy Constructor Passed" << endl;
        }
